"""
Django settings for frosty_forest_41121 project.
...
ROOT_URLCONF = 'frosty_forest_41121.urls'
...
WSGI_APPLICATION = 'frosty_forest_41121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_forest_41121 API",
    "DESCRIPTION": "API documentation for frosty_forest_41121 App",
    "VERSION": "v1",
}
